...
sender_database_cursor.execute("DELETE FROM sent_transactions WHERE user_id = 2234567890")
sender_dastabase_connection.commit()

receiver_database_cursor.execute("DELETE FROM received_transactions WHERE sender_id = 987654321")
receiver_dastabase_connection.commit()
receiver_database_cursor.execute("DELETE FROM received_transactions WHERE user_id = 2234567890")
receiver_dastabase_connection.commit()
